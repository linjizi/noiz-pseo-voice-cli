...
| `voices search <query> [--limit]` | read | find voice_ids by name/voice_id (voices DB → public explore API → CMS records) |
...
| `NOIZ_PUBLICIZE_TOKEN` | no | optional Bearer token sent to URL publicize hooks (prod visibility API) |
